			      	 ...
			      	 if(d.login==inputValue){
			      	 	$.ajax({
								    ...
								    success: function(followersResponse){
                                        ...
                                        $(".cardHolder").append('<div class="cardDiv"><div id="CardNumber'+idNumber+'"><div style="margin-bottom:30px;width:200px;height:270px;padding:10px;border:1.5px solid #d9d9d9;"><p id="'+idNumber+'" onclick="deleteSelectedCard(this.id)" style="cursor: pointer;position: absolute;margin-top: 5px;margin-left: 180px;color: grey;">x</p><a href="'+d.html_url+'"><div><img class = "imag" src="'+d.avatar_url+'" style="width:200px;height:200px;"><h5 class="name" style="height: 1px;margin-left: -10px;">'+name+'</h5><h6 style="height: 1px;"><span><label>Location:</label><label class = "location">Mountain View, CA</label></span></h6><h6  style="height: 1px;"><span><label>Followers:</label><label class = "follower">'+followersResponse.length+'</label></span></h6></div></a></div></div></div>');
